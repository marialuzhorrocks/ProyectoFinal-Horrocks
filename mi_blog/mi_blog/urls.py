...
urlpatterns = [
    ...
    path('pages/', blog_views.pages, name='pages'),  # Ruta para listar las páginas de blogs
    path('pages/<int:page_id>/', blog_views.page_detail, name='page_detail'),  # Ruta para el detalle de cada página
]
